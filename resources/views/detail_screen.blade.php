...
<div class="tab-content" id="myTabContent">
        ...
        <div class="row">
            <div class="col-10">
                <div class="border" style="padding:10px;margin:10px;">
                    ...
                    @if (App\Models\Reservation::get_reservation_rate($scheduled->id, $scheduled->auditorium_id) ===
                    100)
                    <p>×</p>
                    @elseif (App\Models\Reservation::get_reservation_rate($scheduled->id, $scheduled->auditorium_id) >=
                    70)
                    <p>△</p>
                    @else
                    <p>〇</p>
    ...
    <div class="tab-pane fade {{ session('active') || $errors->any()? 'active show':'' }}" id="profile" role="tabpanel" aria-labelledby="profile-tab">
        ...
        <div class="row">
            <div class="col-10">
                <div class="border" style="padding:10px;margin:10px;">
                    <img class="" src="{{ asset('/img/user_icon.jpeg') }}" alt="ユーザーアイコンの画像"><span class="ms-3">{{
                        $movie_review->user->name }}</span>
